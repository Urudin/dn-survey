<section class="bg-red-700 py-12 mt-32 overflow-hidden">
    <div class="container mx-auto px-2 md:px-4 lg:px-8 text-center relative w-full md:w-[80%] lg:w-[70%] xl:w-[60%]">
        ...
        <div class="absolute bottom-[-20px] lg:right-[10px] right-[-10px] rounded-br-[30px] border-b-[1px] border-r-[1px] border-white w-[120px] h-[120px] pointer-events-none z-0"></div>
