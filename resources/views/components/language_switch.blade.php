...
<div class="relative">
    <button id="langToggle" class="flex items-center px-3 py-1 bg-gray-100 border rounded-lg shadow-md hover:bg-gray-200 focus:outline-none">
    ...
    <!-- Dropdown Menu -->
    <div id="langDropdown" class="absolute hidden mt-2 w-44 bg-white border rounded-lg shadow-lg z-50">
